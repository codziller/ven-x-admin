...
export default function Form({ details, toggler }) {
  ...
  return (
    <div className="gap-y-4 py-4 w-full h-full pb-4 overflow-y-auto">
      ...
      {details?.isAdd ? (
        <h2 className="section-heading my-8 text-xl">Add Promo Code</h2>
      ) : (
        <h2 className="section-heading mb-3 text-xl">Edit Promo Code</h2>
      )}
      ...
      >
        ...
        <Button
          ...
          type="submit"
          text={details?.isAdd ? "Add Promo Code" : "Save Changes"}
          className="mt-8 mb-5"
          fullWidth
        />
      </form>
